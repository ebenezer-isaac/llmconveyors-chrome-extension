  ...
  return (
    <div className="w-full">
      <button
        ...
        className="w-full rounded-card border border-brand-500 bg-white px-3 py-2 text-sm font-medium text-brand-900 hover:bg-brand-50 disabled:cursor-not-allowed disabled:opacity-60 dark:border-brand-500 dark:bg-zinc-900 dark:text-brand-50 dark:hover:bg-brand-900"
      >
        {state.kind === 'pending'
          ? state.on
            ? 'Clearing...'
