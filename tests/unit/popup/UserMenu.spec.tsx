...
// The 'UserMenu theme selector' describe block was removed. Theme
// selection now lives in the SurfaceHeader ThemeToggle (tested in
// tests/unit/sidepanel/ThemeToggle.spec.tsx). UserMenu no longer
// duplicates that surface -- see the 'remove usage and theme from
// here, those stuff is repeated' user feedback in commit history.
